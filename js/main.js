function initMap() {
    ...
    $.ajax({
        type: "GET",
        url: "http://158.129.225.30:8080/v1/disturbances",
        data: { },
        success: function(data){
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var marker = new google.maps.Marker({
                    map: map,
                    position: new google.maps.LatLng(data[i].location.longitude, data[i].location.latitude),
                    icon: image
                });
...
function clickMarker(marker, id) {
    (function(marker, id) {
        ...
        google.maps.event.addListener(marker, 'click', function() {
            $.ajax({
                type: "GET",
                url: "http://158.129.225.30:8080/v1/disturbances/" + id,
                data: {} ,
                success: function(data){
